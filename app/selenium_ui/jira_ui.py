...
'''
def test_1_selenium_custom_action_filterUsers(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_specific_action_filterUsers(jira_webdriver, jira_datasets)

def test_1_selenium_custom_action_filterGroups(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_specific_action_filterGroups(jira_webdriver, jira_datasets)

def test_1_selenium_custom_action_mySettings(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_specific_action_mySettings(jira_webdriver, jira_datasets)
'''

def test_1_selenium_custom_action_showMyApps(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.app_specific_action_showMyApps(jira_webdriver, jira_datasets)
